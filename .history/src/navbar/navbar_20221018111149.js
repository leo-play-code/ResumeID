    ...
    return (
        <nav className="navbar">
            ...
            <span className='navbar-center'>
                ...
                <Link to="/Note" onClick={()=>PageSelected(e,'Note')}>Note</Link>
                <Link to="/Roadmap" onClick={()=>PageSelected(e,'Roadmap')}>Roadmap</Link>
                <Link to="/Project" onClick={()=>PageSelected(e,'Project')}>Project</Link>
            </span>
