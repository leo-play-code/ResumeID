    ...
    return (
        <nav className="navbar">
            ...
            {(navbar_state == 'Home')&& <Link to="/" className='page-selected'>Home</Link>}
                ...
                {(navbar_state == 'Roadmap')&& <Link to="/" className='page-selected'>Home</Link>}
                {!(navbar_state == 'Roadmap')&&<Link to="/" onClick={()=>PageSelected('Home')}>Home</Link>}
                {(navbar_state == 'Project')&& <Link to="/" className='page-selected'>Home</Link>}
                {!(navbar_state == 'Project')&&<Link to="/" onClick={()=>PageSelected('Home')}>Home</Link>}
